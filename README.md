...
`gtav_texture_importer` is a GTK4/libadwaita desktop editor for replacing textures inside GTA V `.ydr`, `.yft`, `.ytd`, and `.rpf` assets on Arch Linux.
...
- Lets you browse `.rpf` archives in the middle pane with a path bar, inline folder/package expansion, and supported nested package files.
